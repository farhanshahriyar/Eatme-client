              ...
              <div className="p-4 sm:p-7">
                <div className="text-center">
                  ...
                  <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <a
                      className="text-red-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                      href=""
                    >
                      {''} Login here
                    </a>
                ...
                <div className="mt-5">
                    ...
                    <div className="grid gap-y-4">
                      ...
                      <div>
                        <div className="flex justify-between items-center">
                          ...
                          <a
                            className="text-sm text-red-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                  ...
                  <div className="ms-3">
                    <label for="remember-me" className="text-sm dark:text-white">D</label>
                  </div>
                </div> */}
